...
function Row({
  ...
  return (
    <tr className="row hover:bg-emerald-50">
      ...
      <td className="td">
        <button className="btn" onClick={commit} disabled={isSaving}>
          Guardar
        </button>
      </td>
    </tr>
...
function AddLineModal({
  ...
  function save() {
    ...
    const payload = lotId
      ? { countId, itemId, lotId: lotId as unknown as Id, note: noteClean }
      : { countId, itemId, note: noteClean }; // sem lote -> hook cria/usa NOLOT
          ...
          <div className="scroll">
            <table className="data">
              <thead className="sticky top-0 bg-white/90 backdrop-blur z-10">
                <tr>
                  <th className="th w-[20rem]">Item</th>
                  <th className="th w-[12rem]">Lote</th>
                  <th className="th w-[8rem]">Esperado</th>
                  <th className="th w-[10rem]">Contado</th>
                  <th className="th w-[8rem]">Delta</th>
                  <th className="th w-[14rem]">Notas</th>
                  <th className="th w-[8rem]">Ação</th>
                </tr>
              </thead>
              <tbody>
                {linesQ.isLoading ? (
